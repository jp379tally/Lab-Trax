      ...
      <View style={{ flex: 1, backgroundColor: "#000" }}>
          ...
          {manualMode || !cameraAvailable ? (
            <View style={{ flex: 1, justifyContent: "center", alignItems: "center", paddingHorizontal: 32 }}>
              ...
              <Pressable
                ...
                style={({ pressed }) => ({ marginTop: 16, backgroundColor: manualInput.trim() ? colors.info : "rgba(79,142,247,0.4)", paddingHorizontal: 28, paddingVertical: 12, borderRadius: 12, opacity: pressed ? 0.8 : 1 })}
              >
                <Text style={{ color: colors.textInverse, fontSize: 15, fontFamily: "Inter_600SemiBold" }}>Assign Barcode</Text>
              </Pressable>
            </View>
            ...
            <>
              ...
              <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center" }} pointerEvents="none">
                <View style={{ width: 280, height: 140, borderRadius: 14, overflow: "hidden" }}>
                  <View style={{ position: "absolute", top: 0, left: 0, width: 28, height: 28, borderTopWidth: 3, borderLeftWidth: 3, borderColor: colors.info, borderTopLeftRadius: 14 }} />
                  <View style={{ position: "absolute", top: 0, right: 0, width: 28, height: 28, borderTopWidth: 3, borderRightWidth: 3, borderColor: colors.info, borderTopRightRadius: 14 }} />
                  <View style={{ position: "absolute", bottom: 0, left: 0, width: 28, height: 28, borderBottomWidth: 3, borderLeftWidth: 3, borderColor: colors.info, borderBottomLeftRadius: 14 }} />
                  <View style={{ position: "absolute", bottom: 0, right: 0, width: 28, height: 28, borderBottomWidth: 3, borderRightWidth: 3, borderColor: colors.info, borderBottomRightRadius: 14 }} />
                  <RNAnimated.View
                    style={{
                      position: "absolute",
            ...
            <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
              ...
              <Pressable
                ...
                style={({ pressed }) => ({ marginTop: 16, backgroundColor: colors.info, paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12, opacity: pressed ? 0.8 : 1 })}
              >
        ...
        <View style={{ paddingHorizontal: 20, paddingBottom: platformOS === "web" ? 34 : insetsBottom + 10, paddingTop: 14, alignItems: "center", gap: 12 }}>
          {cameraAvailable && (
            ...
            >
              <Ionicons name={manualMode ? "scan-outline" : "create-outline"} size={18} color={colors.textInverse} />
              <Text style={{ color: colors.textInverse, fontSize: 14, fontFamily: "Inter_600SemiBold" }}>
          ...
          <Text style={{ color: colors.textInverse, fontSize: 18, fontFamily: "Inter_700Bold", textAlign: "center", marginTop: -4 }}>
            Case {caseNumber}
          </Text>
        </View>
      </View>
